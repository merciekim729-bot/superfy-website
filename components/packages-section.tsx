...
function PackagesSection() {
  return (
    <section id="packages" className="py-12 lg:py-20 bg-gradient-to-b from-orange-50 to-white">
            ...
            >
              {pkg.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <Badge className="bg-orange-500 text-white px-3 py-1 text-xs lg:text-sm font-bold animate-pulse">
              ...
              <CardHeader className="text-center pb-4">
                ...
                <div className="mb-4">
                  <span className="text-3xl lg:text-4xl font-bold text-orange-500">Ksh {pkg.price}</span>
                ...
                <ul className="space-y-3 mb-6 lg:mb-8">
                  {pkg.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center">
                      <Check className="h-4 w-4 lg:h-5 lg:w-5 text-orange-500 mr-3 flex-shrink-0" />
