...
function GetConnectedSection() {
  ...
  return (
    <section className="py-12 lg:py-20 bg-gradient-to-r from-navy-900 via-navy-850 to-navy-950 text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <div className="scroll-fade-in-up">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-navy-100 mb-8 lg:mb-12 max-w-3xl mx-auto">
